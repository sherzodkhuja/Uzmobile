...
import com.example.uzmobileapp.adapters.sms.SmsPagerAdapter
import com.example.uzmobileapp.databinding.FragmentSmsBinding
...
class SmsFragment : Fragment() {
    ...
    lateinit var smsCategoryList: ArrayList<SmsCategory>
    lateinit var smsPagerAdapter: SmsPagerAdapter
    ...
    override fun onCreateView(
        ...
        getData()
        smsPagerAdapter = SmsPagerAdapter(smsCategoryList, requireActivity())
        binding.viewPager2.adapter = smsPagerAdapter
    ...
    private fun getData() {
        smsCategoryList = ArrayList()
        smsCategoryList.add(SmsCategory("Oylik", 0))
        smsCategoryList.add(SmsCategory("Haftalik", 1))
        smsCategoryList.add(SmsCategory("Xalqaro", 2))
    }
    ...
    private fun setTabs(tab: TabLayout.Tab, position: Int) {
        ...
        itemTabBinding.txt.text = smsCategoryList[position].name
        if (position == 0) {
